server <- function(input, output,session) {
  ...
  dcf.dashboard::dcf_dashboard_server(
    ...
    tasks = list(
      list(
        id = "task-I.2",
        label = "Task I.2: Nominal catches",
        formats = list(
          list(
            id = "simplified",
            label="Simplified",
            ref= "https://raw.githubusercontent.com/fdiwg/fdi-formats/main/cwp_rh_simplified_wecafc_taskI.2.json"
          ),
          list(
            id = "generic",
            label="Generic",
            ref= "https://raw.githubusercontent.com/fdiwg/fdi-formats/main/cwp_rh_generic_wecafc_taskI.2.json"
          )
        )
      ),
      list(
        id = "task-II.1",
        label = "Task II.1: Catch",
        formats = list(
          list(
            id = "simplified",
            label="Simplified",
            ref= "https://raw.githubusercontent.com/fdiwg/fdi-formats/main/cwp_rh_simplified_wecafc_taskII.1.json"
          ),
          list(
            id = "generic",
            label="Generic",
            ref= "https://raw.githubusercontent.com/fdiwg/fdi-formats/main/cwp_rh_generic_wecafc_taskII.1.json"
          )
        )
      ),
      list(
        id = "task-II.2",
        label = "Task II.2: Effort",
        formats = list(
          list(
            id = "simplified",
            label="Simplified",
            ref= "https://raw.githubusercontent.com/fdiwg/fdi-formats/main/cwp_rh_simplified_wecafc_taskII.2.json"
          ),
          list(
            id = "generic",
            label="Generic",
            ref= "https://raw.githubusercontent.com/fdiwg/fdi-formats/main/cwp_rh_generic_wecafc_taskII.2.json"
          )
        )
      ),
      list(
        id = "task-III.1",
        label = "Task III.1: Fleet engagement",
        formats = list(
          list(
            id = "simplified",
            label="Simplified",
            ref= "https://raw.githubusercontent.com/fdiwg/fdi-formats/main/cwp_rh_simplified_wecafc_taskIII.1.json"
          ),
          list(
            id = "generic",
            label="Generic",
            ref= "https://raw.githubusercontent.com/fdiwg/fdi-formats/main/cwp_rh_generic_wecafc_taskIII.1.json"
          )
        )
      )
    ),
